...
class CrawlerAssetTest(unittest.TestCase):
    ...
    def test_supported_source_exposes_three_capability_slots(self) -> None:
        ...
        self.assertEqual("資料目錄搜尋", asset.capability_profile.source_family_label)
        self.assertEqual("json", asset.capability_profile.transport)
        self.assertEqual("JSON", asset.capability_profile.transport_label)
        self.assertEqual("公開或需審核", asset.capability_profile.auth_mode_label)
        self.assertEqual("公開或需審核", asset.capability_profile.terms_risk_label)
        self.assertEqual("dataset_list", asset.capability_profile.result_shape)
        self.assertEqual("資料集清單", asset.capability_profile.result_shape_label)
        ...
        self.assertEqual("資料目錄搜尋", payload["source_family_label"])
        self.assertEqual("json", payload["transport"])
        self.assertEqual("JSON", payload["transport_label"])
        self.assertEqual("公開或需審核", payload["auth_mode_label"])
        self.assertEqual("公開或需審核", payload["terms_risk_label"])
        self.assertEqual("dataset_list", payload["result_shape"])
        self.assertEqual("資料集清單", payload["result_shape_label"])
        self.assertEqual("paginated_catalog", payload["seed_scope"])
        self.assertEqual("分頁 catalog", payload["seed_scope_label"])
