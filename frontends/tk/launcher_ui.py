...
class ApiCollectionUi(AiSummaryWorkflowMixin, DiscoveryWorkflowMixin, PlanWorkflowMixin, ProviderSettingsWorkflowMixin, ImportWorkflowMixin, DownloadWorkflowMixin, OAuthWorkflowMixin, RepairWorkflowMixin, MvpDemoWorkflowMixin, YfinanceWorkflowMixin):
