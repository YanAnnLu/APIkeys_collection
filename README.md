...
- Long-term direction: support a paired mobile companion app as a remote controller for status, notifications, and safe job actions while data and credentials stay on the desktop/service side.
- Long-term option: become an opt-in BitTorrent-like node for redistributable public datasets, guarded by license, version, and checksum manifests.
