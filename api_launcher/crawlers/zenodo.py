...
def paginated_zenodo_candidates(
    ...
    return list(paginated_zenodo_output(source, search_term, timeout, page_size, max_pages).candidates)


def paginated_zenodo_output(
    source: DatasetDiscoverySource,
    search_term: str,
    timeout: float,
    page_size: int,
...
def zenodo_candidates_for_source(
    ...
    for term in search_terms or ("",):
        if full_crawl:
            output = paginated_zenodo_output(source, term, timeout, limit, max_pages)
