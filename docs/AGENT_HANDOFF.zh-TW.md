...
3. 繼續擴充 crawler source 類型，但要維持設定檔驅動；Dataverse/Zenodo/DataCite 已有 metadata parser 與 pagination flow，下一批可評估 OGC API Records、Socrata、OpenAlex 類 metadata 來源。
