...
3. 繼續擴充 crawler source 類型，但要維持設定檔驅動；Dataverse/Zenodo 已有 metadata parser，下一批可評估 OGC API Records、Socrata、OpenAlex/DataCite 類 metadata 來源。
