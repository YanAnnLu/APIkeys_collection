...
2. 補上 repair panel，讓 manifest 問題可以從 UI 看到並重排下載。
...
目前優先任務是延伸 api_launcher/library_actions.py 的共用規則到 agent skill，並繼續做 repair panel、data-store connection testing。
