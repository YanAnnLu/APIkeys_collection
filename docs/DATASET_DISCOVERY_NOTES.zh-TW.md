...
- `api_launcher/crawlers/dataset_sources.py`：目前保留 dispatcher、pagination glue 與尚未拆出的 source-type parser，負責從 provider/source 的搜尋 API、ERDDAP `allDatasets`、HTML index、NASA CMR、GBIF、Dataverse、Zenodo 抓取可審核的 dataset candidate。
