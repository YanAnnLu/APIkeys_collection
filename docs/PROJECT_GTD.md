...
| Cross-platform setup | MVP | Git/GitHub, Docker, PowerShell/bash runners, GitHub Actions CI for Windows/Ubuntu, example/local config split, UTF-8/LF rules, startup environment checks. | Add macOS setup notes and CI coverage for renderer-light smoke checks. |
