...
- Use `--handoff-report-json` when a heartbeat or external agent needs the same handoff snapshot as JSON stdout instead of parsing the Markdown `--handoff-report` file.
