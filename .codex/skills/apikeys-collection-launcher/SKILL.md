...
- Provider/source discovery UI must remain metadata-only. Writing `provider_candidates.ui.json` is a review handoff, not catalog promotion, install, credential probing, or source ingestion.
