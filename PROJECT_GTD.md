...
| Download plan/cart | MVP | Download Plan panel, add/remove/clear/export plan JSON, double-click source row to add. | Turn plan items into executable download jobs with adapters. |
...
| Cross-platform setup | MVP | Git/GitHub, Docker, PowerShell runner, example/local config split. | Add CI workflow and clearer Windows/macOS setup notes. |
