...
| Download engine | Skeleton | Nonblocking worker queue with progress snapshots, pause, resume, cancel, and tests. | Add real HTTP/API/database adapters with ranged resume support and retry policy. |
